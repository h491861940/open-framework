package com.open.framework.core.config.lifecycle;
 ...
 * CommandLineRunner 在项目启动后执行
 * 
 * 
 */
@Component
public class OpenSmartLifecycle implements SmartLifecycle {
    ...
    @Override
    public void start() {
        System.out.println("start SmartLifecycle");
    ...
    public void stop(Runnable callback) {
        ...
        // 否则在你程序退出时，Spring的DefaultLifecycleProcessor会认为你这个OpenSmartLifecycle没有stop完成，程序会一直卡着结束不了，等待一定时间（默认超时时间30秒）后才会自动结束。
